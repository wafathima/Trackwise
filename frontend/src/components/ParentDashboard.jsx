...
//       ],
//       notifications: [
//         { id: 1, message: 'Alex completed 5 study sessions this week!', type: 'achievement', date: '2024-01-15' },
//         { id: 2, message: 'Alex scored 92% in Physics test', type: 'score', date: '2024-01-14' },
//         { id: 3, message: 'Study streak: 5 days! Keep going!', type: 'streak', date: '2024-01-13' }
//       ]
//     }
//   ]);
...
//     if (score >= 75) return { label: 'Good', color: 'text-teal-600', bg: 'bg-teal-50' };
//     if (score >= 50) return { label: 'Needs Improvement', color: 'text-yellow-600', bg: 'bg-yellow-50' };
...
//               Monitoring {childrenProfiles.length} child{childrenProfiles.length > 1 ? 'ren' : ''} • {stats.totalAchievements} achievements • {stats.totalStreak} day streak
//             </p>
//           </div>
...
//                 </div>
//                 <div>
//                   <p className="text-2xl font-bold text-gray-900">{stats.averageDiscipline}%</p>
//                   <p className="text-xs text-gray-500">Avg Discipline</p>
//                 </div>
//               </div>
//             </div>
...
//                   <p className="text-xs text-gray-500">Best Streak (Days)</p>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//               return (
//                 <div key={child.id} className="bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition">
//                   <div 
...
//                         <div className="w-14 h-14 rounded-full bg-gradient-to-br from-pink-500 to-purple-500 flex items-center justify-center text-white font-bold text-xl shadow-md">
//                           {child.name.charAt(0)}
//                         </div>
//                         <div>
//                           <h4 className="text-lg font-bold text-gray-900">{child.name}</h4>
//                           <p className="text-xs text-gray-500">Class {child.class} Standard</p>
//                         </div>
//                       </div>
                      
//                       <div className="flex items-center gap-4 flex-wrap">
//                         <div className="flex items-center gap-2">
//                           <div className={`px-3 py-1 rounded-full text-xs font-medium ${discipline.bg} ${discipline.color}`}>
//                             {discipline.label}
//                           </div>
//                           <span className="text-sm font-bold text-gray-900">{child.disciplineScore}%</span>
//                         </div>
...
//                           <p className="text-lg font-bold text-gray-900">{child.studyStreak} days</p>
//                         </div>
//                         <div className="bg-white p-3 rounded-xl border border-gray-200">
//                           <p className="text-xs text-gray-500">Workout Streak</p>
//                           <p className="text-lg font-bold text-gray-900">{child.workoutStreak} days</p>
//                         </div>
//                         <div className="bg-white p-3 rounded-xl border border-gray-200">
//                           <p className="text-xs text-gray-500">Attendance</p>
//                           <p className="text-lg font-bold text-gray-900">{child.attendance}%</p>
//                         </div>
//                         <div className="bg-white p-3 rounded-xl border border-gray-200">
//                           <p className="text-xs text-gray-500">Achievements</p>
//                           <p className="text-lg font-bold text-gray-900">{child.achievements.length}</p>
//                         </div>
//                       </div>
...
//                             <div key={notif.id} className="flex items-center gap-3 p-2 bg-gray-50 rounded-lg">
//                               <div className={`w-2 h-2 rounded-full ${
//                                 notif.type === 'achievement' ? 'bg-emerald-500' :
//                                 notif.type === 'score' ? 'bg-blue-500' :
//                                 'bg-amber-500'
//                               }`} />
//                               <span className="text-xs text-gray-700 flex-1">{notif.message}</span>
...
//                           <div>
//                             <p className="text-xs text-gray-500 font-medium">Hydration Log</p>
//                             <p className="text-sm font-bold text-gray-900">{child.waterIntake}</p>
//                           </div>
//                         </div>
...
//                           <div>
//                             <p className="text-xs text-gray-500 font-medium">Sleep Rest Cycle</p>
//                             <p className="text-sm font-bold text-gray-900">{child.sleep}</p>
//                           </div>
//                         </div>
...
//                           <div>
//                             <p className="text-xs text-gray-500 font-medium">Active Study Streak</p>
//                             <p className="text-sm font-bold text-gray-900">{child.studyStreak} Days</p>
//                           </div>
//                         </div>
//                       </div>
//                     </div>
...
//         <div className="space-y-6">
//           {childrenProfiles.map((child) => (
//             <div key={child.id} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
//               <div className="flex justify-between items-center mb-6">
//                 <h4 className="text-lg font-bold text-gray-900">{child.name}'s Progress</h4>
//                 <button 
...
//               {/* Subject Performance */}
//               <div className="mb-6">
//                 <h5 className="text-sm font-semibold text-gray-700 mb-3">Subject Performance</h5>
...
//                         />
//                       </div>
//                       <p className="text-xs text-gray-500 mt-1">Progress: {subject.progress}%</p>
//                     </div>
//                   ))}
//                 </div>
//               </div>
...
//               {/* Weekly Study Hours */}
//               <div className="mb-6">
//                 <h5 className="text-sm font-semibold text-gray-700 mb-3">Weekly Study Hours</h5>
//                 <div className="flex items-end gap-2 h-32">
//                   {child.weeklyStudyHours.map((hours, idx) => (
//                     <div key={idx} className="flex-1 flex flex-col items-center">
//                       <div 
//                         className="w-full bg-gradient-to-t from-teal-500 to-emerald-400 rounded-t-lg transition-all duration-500"
//                         style={{ height: `${(hours / 8) * 100}%` }}
//                       />
//                       <span className="text-[10px] text-gray-500 mt-1">{['M','T','W','T','F','S','S'][idx]}</span>
//                       <span className="text-[10px] font-bold text-gray-700">{hours}h</span>
//                     </div>
//                   ))}
//                 </div>
//               </div>
...
//               {/* Weekly Workouts */}
//               <div>
//                 <h5 className="text-sm font-semibold text-gray-700 mb-3">Weekly Workout Completion</h5>
//                 <div className="flex gap-2">
//                   {child.weeklyWorkouts.map((completed, idx) => (
//                     <div key={idx} className="flex-1 text-center">
//                       <div className={`p-2 rounded-lg ${completed ? 'bg-emerald-100' : 'bg-gray-100'}`}>
//                         {completed ? 
...
//           {childrenProfiles.map((child) => (
//             <div key={child.id} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
//               <h4 className="text-lg font-bold text-gray-900 mb-4">{child.name}'s Daily Habits</h4>
              
//               <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                 {child.dailyHabits.map((habit, idx) => (
//                   <div key={idx} className="bg-gray-50 p-4 rounded-xl border border-gray-200 flex items-center justify-between">
//                     <div className="flex items-center gap-3">
...
//                       habit.completed ? 'bg-emerald-50 text-emerald-700' : 'bg-gray-100 text-gray-500'
//                     }`}>
...
//                   <div>
//                     <p className="text-sm font-medium text-gray-700">Overall Discipline Score</p>
//                     <p className="text-2xl font-bold text-gray-900">{child.disciplineScore}/100</p>
//                   </div>
//                   <div className="flex items-center gap-2">
//                     <div className="w-16 h-16 rounded-full border-4 border-pink-500 flex items-center justify-center">
//                       <span className="text-xl font-bold text-pink-600">{child.disciplineScore}%</span>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//           {childrenProfiles.map((child) => (
//             <div key={child.id} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
//               <h4 className="text-lg font-bold text-gray-900 mb-4">{child.name}'s Achievements</h4>
              
//               <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
//                 {child.achievements.map((achievement, idx) => (
//                   <div key={idx} className="bg-gradient-to-br from-amber-50 to-yellow-50 p-4 rounded-xl border border-amber-200 text-center">
//                     <div className="w-16 h-16 bg-gradient-to-br from-amber-400 to-yellow-500 rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
//                       <Award className="w-8 h-8 text-white" />
//                     </div>
//                     <h6 className="font-semibold text-gray-900">{achievement}</h6>
//                     <p className="text-xs text-gray-500">Earned Achievement</p>
//                   </div>
//                 ))}
//               </div>
...
//                   <p className="text-2xl font-bold text-gray-900">{child.achievements.length}</p>
//                   <p className="text-xs text-gray-500">Total Badges</p>
//                 </div>
//                 <div className="bg-gray-50 p-3 rounded-xl text-center border border-gray-200">
//                   <p className="text-2xl font-bold text-emerald-600">{child.studyStreak}</p>
//                   <p className="text-xs text-gray-500">Study Streak</p>
//                 </div>
//                 <div className="bg-gray-50 p-3 rounded-xl text-center border border-gray-200">
//                   <p className="text-2xl font-bold text-amber-600">{child.workoutStreak}</p>
//                   <p className="text-xs text-gray-500">Workout Streak</p>
//                 </div>
//                 <div className="bg-gray-50 p-3 rounded-xl text-center border border-gray-200">
//                   <p className="text-2xl font-bold text-pink-600">{child.disciplineScore}%</p>
...
//               <div>
//                 <label className="text-xs text-gray-600 block mb-1">Select Child</label>
...
//               </div>
//               <div>
//                 <label className="text-xs text-gray-600 block mb-1">Week</label>
//                 <input type="week" className="w-full bg-gray-50 border border-gray-300 rounded-xl px-4 py-2 text-gray-900 focus:ring-2 focus:ring-teal-500" />
//               </div>
//               <div>
